...
class GameInputs:
    def __init__(self):
        self.keys_down: list = []
        self.key_downs: list = []
        self.mouse_pos: array = array((0,0))
        self.mouses_down: list = []

class Game:
    def __init__(self):
        self.settings = Settings()
        self.running = True
        self.camera = Camera((0,0), self.settings.resolution)
        self.entities = []
    ...
    def get_rendered_screen(self):
        return self.camera.get_rendered_screen(self.entities)